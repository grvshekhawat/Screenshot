...
SaaS editor for App Store and Google Play screenshots (Next.js). Create up to 5 projects free; subscribe (Stripe) to export PNG/ZIP.
...
4. Deploy Edge Functions under `supabase/functions/` and set Stripe secrets
5. Fill `.env` with `NEXT_PUBLIC_*` from `.env.example` and deploy to Vercel as a **Next.js** app
